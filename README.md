...
### [2025.01.09] v11.0.7.0
- 11.0.7.0 대응 업데이트
- [기능추가] 주문 쿨다중 중에 아이콘을 숨김하는 기능 추가
- [오류수정] 일부 주문에서 반짝임 기능이 제대로 동작하지 않는 문제 수정

### [2024.09.12] v11.0.2.3
- [오류수정] 쿨다운 기능에서 글로벌 쿨다운 표시가 제대로 동작하지 않는 문제 수정
- [오류수정] 쿨다운 기능에서 아이템 등록 시 기능이 제대로 동작하지 않는 문제 수정

### [2024.08.31] v11.0.2.2
- [오류수정] 주문 툴팁 보기 기능이 동작하지 않는 문제 수정
- [오류수정] 공유 문자열 생성이 되지 않는 문제 수정
